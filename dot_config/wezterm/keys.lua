...
table.insert(config.keys, {
	key = "n",
	mods = "LEADER",
	action = act.SwitchToWorkspace({ name = "Neovim" }),
})

table.insert(config.keys, {
	key = "W",
	mods = "LEADER",
	action = act.SwitchToWorkspace({ name = "Wiki" }),
})

table.insert(config.keys, {
	key = "u",
	mods = "LEADER",
	action = act.SwitchToWorkspace({ name = "Upgrade" }),
})

table.insert(config.keys, {
	key = "y",
	mods = "LEADER",
	action = act.SwitchToWorkspace({ name = "YouTube" }),
})
